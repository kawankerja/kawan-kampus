...
const emailRequiredIndicator = document.getElementById(
	"emailRequiredIndicator"
);

// Check if the email input is required
...
const passwordRequiredIndicator = document.getElementById(
...
function togglePasswordVisibility() {
	if (passwordInput.type === "password") {
		...
		eyeIcon.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-[#636363]">
