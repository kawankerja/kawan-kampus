...
const editKepegawaian = document.getElementById("edit-kepegawaian");
const inputKepegawaian = document.querySelectorAll("form.kepegawaian input");

const editLainLain = document.getElementById("edit-lain-lain");
const infoNPWP = document.getElementById("info-npwp");

console.log(editLainLain);

editLainLain.addEventListener("click", () => {
	editLainLain.classList.toggle("hidden");
	infoNPWP.classList.toggle("hidden");
	document.getElementById("batal-simpan-lain").classList.toggle("hidden");
	document.getElementById("btn-npwp").classList.toggle("hidden");
	document.getElementById("btn-npwp-edit").classList.toggle("hidden");
});

editKepegawaian.addEventListener("click", () => {
	editKepegawaian.classList.toggle("hidden");
	document.getElementById("btn-SK").classList.toggle("hidden");
	document.getElementById("btn-SK-edit").classList.toggle("hidden");

	document.getElementById("btn-sertif").classList.toggle("hidden");
	document.getElementById("btn-sertif-edit").classList.toggle("hidden");

	inputKepegawaian.forEach((item) => {
		item.disabled = false;
	});

	document
		.getElementById("batal-simpan-kepegawaian")
